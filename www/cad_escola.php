                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    <div class="row m-b-20">
                                        <div class="col-md-12">
                                            <h3 class="text-center">Sistema Bibliotecário</h3>
                                            <p class="text-center">Novo cadastro de instituição</p>
                                        </div>
                                    </div>
                                    <div class="form-group form-primary">
                                            <input type="text" id="nome" name="cad_escola" class="form-control" required="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            ...
                                            <p class="text-inverse text-left"><a href="index.php"><b>Retornar</b></a></p>
                                        </div>
                                        <div class="col-md-2">
    ...
    $(function(){
        $('.cadastro').click(function(){
            ...
            if(nome == ''){
                ...
                $.ajax({
                    type: "POST",
                    url: "cad_escola/salva_escola.php",
                    data: {'nome':nome},
